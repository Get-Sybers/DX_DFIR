...
| [go-evtx](https://github.com/Velocidex/evtx) (Velociraptor) | `get_sybers_dxdfir.evtx` runs **goevtx** (`get-sybers/goevtx`, `docker/GoDFIR-toolz/goevtx`) — a static-Go `.evtx` parser on go-evtx | Apache-2.0 | None |
