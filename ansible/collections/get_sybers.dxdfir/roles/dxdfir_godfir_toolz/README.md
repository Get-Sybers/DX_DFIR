...
per-host artefact output for the Elastic-native pipeline. Every tool
...
| `dxdfir_godfir_toolz_out_dir` | `<repo>/data_store/processed/godfir-toolz` | Output base (override for a custom location). |
