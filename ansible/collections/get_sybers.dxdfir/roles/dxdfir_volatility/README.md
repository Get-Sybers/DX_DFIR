...
Elastic-native pipeline. The role is structure only — it asserts inputs,
...
| `dxdfir_volatility_out_dir` | `<repo>/data_store/processed/volatility` | Output base (override for a custom location). |
