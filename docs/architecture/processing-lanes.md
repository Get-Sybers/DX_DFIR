...
| **volatility** | Memory images (`raw/memory`) | [PIIAT-Mem](https://github.com/Get-Sybers/PIIAT-Mem) (Volatility 3) | `get-sybers/volatility` | `volatility/<image>/plugins/*.jsonl` |
...
| **zimmerman** | Same disk-image family | [GoDFIR-toolz](https://github.com/Get-Sybers/GoDFIR-toolz) EZ-tools (gore, gomft, goese, goprefetch…) | `get-sybers/<tool>` + `get-sybers/plaso` for extraction | `zimmerman/<host>/` |
