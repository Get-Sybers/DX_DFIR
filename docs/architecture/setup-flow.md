...
| 4 | **Git submodules** | `submodule update --init --recursive` — [PIIAT-Mem](https://github.com/Get-Sybers/PIIAT-Mem) (memory lane) and [GoDFIR-toolz](https://github.com/Get-Sybers/GoDFIR-toolz) (the tool images). |
