...
**Grounded in:** `data_store/processed/log2timeline/jsonl/DESKTOP-PM6C56D.jsonl` (LoneWolf `LoneWolf.E01`, 4,169,774 plaso events, incl. VSS shadow copies VSS1/VSS2). Engine maps: `byakugan/byakugan/mappings/plaso_registry.py`, `plaso_fs_extra.py`, `plaso_exec.py`, `sysmon.py`; sources `sources/plaso_*.yaml`.
