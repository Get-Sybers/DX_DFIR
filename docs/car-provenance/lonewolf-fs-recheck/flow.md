...
- Mapped-but-empty SRUM: `byakugan/piiat_mitrecar/mappings/plaso_srum.py:73`; source decl `piiat_mitrecar/sources_model.py:120`; SRUM two-step lane `ansible/collections/get_sybers.dxdfir/roles/dxdfir_zimmerman/` (output `data_store/processed/zimmerman/` — empty).
