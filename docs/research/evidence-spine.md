...
> ([01](https://github.com/Get-Sybers/byakugan/blob/main/docs/research/cross-source-linkage/01-linkage-volume-guid.md)–[09](https://github.com/Get-Sybers/byakugan/blob/main/docs/research/cross-source-linkage/09-behaviour-sightings.md)) works the
...
**Connection to [Step 01](https://github.com/Get-Sybers/byakugan/blob/main/docs/research/cross-source-linkage/01-linkage-volume-guid.md).** That step had to *mine*
...
to the REG_BINARY byte-preservation from [Step 04](https://github.com/Get-Sybers/byakugan/blob/main/docs/research/cross-source-linkage/04-plaso-binary-loss.md).)
...
- memory captures & pcaps as roots — owned by host, not disk→volume→file shaped
  ...
  [Step 03](https://github.com/Get-Sybers/byakugan/blob/main/docs/research/cross-source-linkage/03-network-identity.md));
...
- Companion analysis arc: [`README.md`](https://github.com/Get-Sybers/byakugan/blob/main/docs/research/cross-source-linkage/README.md),
  [Step 01 — Volume GUID](https://github.com/Get-Sybers/byakugan/blob/main/docs/research/cross-source-linkage/01-linkage-volume-guid.md),
  [Step 04 — REG_BINARY preservation](https://github.com/Get-Sybers/byakugan/blob/main/docs/research/cross-source-linkage/04-plaso-binary-loss.md),
  [Step 06 — behaviour timeline / the layer distinction](https://github.com/Get-Sybers/byakugan/blob/main/docs/research/cross-source-linkage/06-behaviour-timeline.md).
