...
Config file shape (every key optional)::
    ...
    rules_dir: python/get_sybers_dxdfir/detect/rules   # default: the package's own rules
...
# The Elastic stack this repo deploys (docker/elastic/.env.example ELASTIC_VERSION,
